      ...
      <div class="setting-body">
        <div class="logo">
          ...
          <p>
            ...
            <a href="https://github.com/ymc-github/fr-player" target="_blank">{{t('setting.pc')}}</a>
            <a href="https://github.com/ymc-github/fr-player-app" target="_blank">{{t('setting.mobile')}}</a>
          </p>
        </div>
